...
const Settings: Component = () => {
  return (
    <Portal mount={document.getElementById("modal")!}>
      ...
      >
        <Portal>
          <div class='w-10 h-10 absolute z-30 top-0 right-0 m-5'>
            <button
                      ...
                      src={
                        Solenoid.avatarImage()
                          ...
                          : member_avatar_url() || revolt.user?.avatar
                            ? `https://autumn.revolt.chat/avatars/${Solenoid.servers.current_server.me?.avatar?.id ||
        ...
        >
          ...
          <p>Save statuses for later use</p>
